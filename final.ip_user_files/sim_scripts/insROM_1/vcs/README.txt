...
#
# Generated by export_simulation on Thu Nov 17 17:16:32 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './insROM.sh' script.
...
./insROM.sh -noclean_files

For more information on the script, please type './insROM.sh -help'.
